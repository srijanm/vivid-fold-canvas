...
const Index = () => {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundImage: `url(${gradientBg})`, backgroundSize: 'cover', backgroundAttachment: 'fixed' }}>
        ...
        >
          <div className="text-left z-10 max-w-4xl mb-8">
            <h1 className="text-xl md:text-2xl font-bold text-foreground leading-relaxed uppercase">
              ...
              <br /><br />
              because mithai should be eaten HAQQ SE.
              <br /><br />
      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden py-16 px-6 md:px-8" style={{ backgroundImage: `url(${gradientBg})`, backgroundSize: 'cover', backgroundAttachment: 'fixed' }}>
        {/* Top Border */}
        <div 
        ...
        />
        <div className="max-w-4xl z-10 w-full px-2">
          <h2 className="text-4xl md:text-5xl lg:text-7xl font-bold text-center mb-8 md:mb-12 text-foreground uppercase">
